...
part of 'meditation_week_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MeditationWeekDto _$MeditationWeekDtoFromJson(Map<String, dynamic> json) =>
    MeditationWeekDto(
...
Map<String, dynamic> _$MeditationWeekDtoToJson(MeditationWeekDto instance) =>
    <String, dynamic>{
      'id': instance.id,
